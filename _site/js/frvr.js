...
const fukdstrobe = document.querySelectorAll(".strobe");
const multistobe = fukdstrobe.forEach(changeColor(element));
...
function changeColor() {
    ...
    if (delay > 3) {
        multistrobe.style.color = getRandomColor();
        delay = 0;
    }
...
function getRandomColor() {
    ...
    // make sure single character values are prepended with a "0"
    if (hexR.length == 1) {
        hexR = "0" + hexR;
    }
